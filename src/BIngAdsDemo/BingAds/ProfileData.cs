...
{
    public class ProfileData : ExampleBase
    {
        // The full path to the profile data file.

        private const string LocalFile = @"C:\Users\vu.pham\Downloads\profiledata.csv";
        ...
        // All supported profile type: CompanyName, Industry, JobFunction, JobSeniority, JobTitle
        private const ProfileType ProfileTypeEnum = ProfileType.JobFunction;

        public override string Description
        {
            get { return "Profile Data | Campaign Management V13"; }
        }
        ...
        public async override Task RunAsync(AuthorizationData authorizationData)
        {
            ...
            try
            {
                ...
                var geProfileDataFileUrlResponse = await CampaignManagementExampleHelper.GetProfileDataFileUrlAsync(
                ...
                var previousSyncTimeUtc = new DateTime(2020, 8, 10, 0, 0, 0, DateTimeKind.Utc);

                var fileUrl = geProfileDataFileUrlResponse.FileUrl;
                var fileUrlExpiryTimeUtc = geProfileDataFileUrlResponse.FileUrlExpiryTimeUtc;
                var lastModifiedTimeUtc = geProfileDataFileUrlResponse.LastModifiedTimeUtc;
