...
namespace BingAdsDemo.BingAds
{
    public class AdExtensions : ExampleBase
    {
        ...
        private const string MediaFilePath = "C:\\Users\\vu.pham\\Downloads\\";
        private const string ImageAdExtensionMediaFileName = "dalat_ratio_169.png";
            ...
            try
            {
                ...
                var adExtensions = new AdExtension[] {
                    ...
                    new ReviewAdExtension
                    {
                        IsExact = true,
                        Source = "Agoda",
                        Text = "This is review rate about Dalat Palace",
                        // The Url of the third-party review. This is not your business Url.
                        Url = "https://www.agoda.com/dalat-palace-heritage-hotel/hotel/dalat-vn.html?ds=HNYv3LeQYoV6VISH"
                    },
                ...
                var adExtensionEditorialReasonCollection =
                    (AdExtensionEditorialReasonCollection[])getAdExtensionsEditorialReasonsResponse?.EditorialReasons?.ToArray();
