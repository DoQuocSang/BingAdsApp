...
using global::BingAdsDemo.BingAdsExampleLibrary.v13;
...
namespace BingAdsDemo.BingAds
{
    ...
    public class ResponsiveAds : ExampleBase
    {
        ...
        private const string ResponsiveAdMediaFileName = "cold-mountain-1911.jpg";
            ...
            try
            {
                ...
                var campaigns = new[]{
                    new Campaign
                    {
                        ...
                        Name = "Campaign for Responsive Ads Demo " + DateTime.UtcNow,
                ...
                var ads = new Ad[] {
                    new ResponsiveAd
                    {
                        ...
                        CallToAction = CallToAction.ShopNow,
                        CallToActionLanguage = LanguageName.English,
                        FinalUrls = new[] {
